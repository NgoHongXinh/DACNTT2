...
CODE_ERROR_COMMENT_CODE_NOT_FOUND = "05"
CODE_ERROR_CANT_CHANGE_INFO = '06'
CODE_ERROR_WHEN_UPDATE_CREATE = "07"

CODE_ERROR_INPUT = "08"
CODE_ERROR_WHEN_UPDATE_CREATE_NOTI = '09'
CODE_ERROR_WHEN_UPDATE_CREATE_FRIEND_REQUEST = "10"
CODE_ERROR_WHEN_UPDATE_CREATE_USER = '11'
CODE_ERROR_FRIEND_REQUEST_NOT_FOUND = "12"

CODE_ERROR_NOTIFICATION_CODE_NOT_FOUND = "13"
