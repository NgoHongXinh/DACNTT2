...
=======
        ...
        self.user_code = user_code  # user code thể hiện người nào sẽ nhận thông báo
        self.user_code_guest = user_code_guest  # user code của người mà tương tác để tạo thông báo đến cho người kia
        self.content = content
